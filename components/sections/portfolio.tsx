...
const categories = [
  "All", "Web Design", "Logo Design", "Web Development", "E-commerce"
];
...
const projects = [
  {
    ...
    category: "Web Design",
    description: "A responsive dashboard design for a SaaS platform with data visualization.",
  ...
  },
  {
    ...
    category: "Web Design",
    description: "Elegant website for a premium artisan bakery showcasing their products.",
  ...
  },
  {
    ...
    category: "Web Development",
    description: "Custom blog platform designed for travel enthusiasts and photographers.",
    image: "https://images.pexels.com/photos/3757148/pexels-photo-3757148.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Explore our portfolio of beautiful designs and powerful web applications that have helped our clients succeed.
          </p>
        </div>
                    ...
                    .map((project, index) => (
                      ...
                      >
                        ...
                        <CardContent className="p-6">
                          ...
                          <Button variant="ghost" className="justify-start pl-0" size="sm">
        ...
        <div className="flex justify-center mt-12">
          <Button>View All Projects <ArrowRight size={16} className="ml-2" /></Button>
        </div>
      </div>
    </section>
  );
