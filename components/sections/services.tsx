...
const services = [
  ...
  },
  {
    ...
    title: "Logo Creation",
    description:
      "Memorable brand identities that capture your brand's essence and stand out in the market.",
    color:
  ...
  },
  {
    ...
    description:
      "Optimized experiences for all devices, ensuring your site looks great everywhere.",
    color:
  ...
  },
  {
    ...
    description:
      "Improved visibility and ranking in search engines to drive organic traffic to your site.",
  ...
  },
  {
    ...
    description:
      "Robust online stores that provide seamless shopping experiences and drive sales.",
  ...
  },
  {
    ...
    description:
      "Strategic digital marketing services to grow your online presence and reach more customers.",
